...
from config import USERNAME, PASSWORD, USER1, BLACKLIST
...
with smart_run(session):
    ...
    while True:
        print(f"\n\n===================== LOOP: {counter} =====================\n\n")
        session.follow_likers ([USER1], photos_grab_amount = 3, follow_likers_per_photo = 300, randomize=False, sleep_delay=80, interact=False)
